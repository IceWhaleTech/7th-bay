...
const char* ssid = "ZimaCubeHub";  // Enter SSID here
...
void loop() {
  ...
  if (lightUpdater.check()) render();

  if (debugTimer.check()) debugger();
...
void fadeEffect() {
  ...
  if (lightness < 1) colorAlgorithmTimer.interval(2000); // enhance the interval
  else if (lightness > 254) colorAlgorithmTimer.interval(1500); // enhance the interval
  else colorAlgorithmTimer.interval(15);
